function [B, W1, p_WB] = beamselect_and_W1form(numberofBeams, N1, N2, Nr, Nt, H_WB)
      if N1 > 1
          O1 = 4;
      else
          O1 = 1;
      ...
      V_WB = V(:, 1);
      W2_WB = W1' * V_WB;
      w2_max = max(W2_WB((1:numberofBeams),1));
      w2_max_polar = max(W2_WB(((numberofBeams + 1) : 2 * numberofBeams),1));
      [p_WB] = wideband_quantization(w2_max, w2_max_polar, numberofBeams);
